...
h(x) = m_3*x*x + b_3
i(x) = m_4*x*x + b_4
fit f(x) "output/karger/matrice_adjacence/data/cycle.dat" using 1:2 via m_1,b_1
fit g(x) "output/karger/matrice_adjacence/data/complet.dat" using 1:2 via m_2,b_2
fit h(x) "output/karger/matrice_adjacence/data/biparti.dat" using 1:2 via m_3,b_3
fit i(x) "output/karger/matrice_adjacence/data/rand08.dat" using 1:2 via m_4,b_4
